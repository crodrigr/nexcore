...
-- =============================================================================
-- BLOQUE 0 — LIMPIEZA PREVIA (hace el script idempotente)
-- TRUNCATE CASCADE elimina en cascada todas las FKs dependientes.
-- El orden refleja la jerarquía de dependencias para mayor claridad,
-- pero CASCADE se encarga de todo.
-- =============================================================================

    RAISE NOTICE '=== BLOQUE 0: Limpieza de tablas ===';
